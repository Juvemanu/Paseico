...
public class OpeningActivity extends AppCompatActivity {
    ...
    private boolean isUserSigned() { //CHECK IF THE USER ALREADY SIGNED IN
    ...
    private void goToMainMenu() { //REDIRECTS THE USER TO DIFFERENTS MAINMENU IF THE USER IS A ROUTER OR AN ORGANIZATION
