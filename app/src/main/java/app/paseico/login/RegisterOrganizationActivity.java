...
public class RegisterOrganizationActivity extends AppCompatActivity {
    ...
    private void checkRegister() {
        ...
        if (areAllFormFieldsFIlled()) { //Check that the fields aren't empty
    ...
    private void checkAndRegister() { //Checks for illegal caracters and if there is no illegal characters submits the register of the organization
